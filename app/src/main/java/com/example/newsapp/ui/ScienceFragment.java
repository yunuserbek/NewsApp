...
public class ScienceFragment extends Fragment {
    ...
    String country ="tr";
    private RecyclerView recyclerViewofsience;
    private String category ="sience";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View v = inflater.inflate(R.layout.sciencefragment,null);
        recyclerViewofsience =  v.findViewById(R.id.recyclerviewofscience);
        modelClassArrayList = new ArrayList<>();
        recyclerViewofsience.setLayoutManager(new LinearLayoutManager(getContext()));
        newsAdapter =new NewsAdapter(getContext(),modelClassArrayList);
        recyclerViewofsience.setAdapter(newsAdapter);
